<?php get_header(); 
	...
	while ( have_posts() ) {
		...
		<?php if(get_field('dont_show_inner_post_image') == false) { ?>
	    	<div class="main-image cover" style="background-image: url(<?php echo !empty(get_field('inner_post_featured_image')) ? get_field('inner_post_featured_image')['sizes']['large'] : $src[0]; ?>); background-position: 50% <?php echo !empty(get_field('inner_post_featured_image_position')) || get_field('inner_post_featured_image_position') === '0' ? get_field('inner_post_featured_image_position').'%' : '50%' ?>"></div>
	    <?php } ?>
	    ...
	    <div class="flex main-post-wrapper">
	    	<div class="col col-shares">
	    		<div class="shares-outer">
			    	<div class="shares" data-url="<?php the_permalink(); ?>" data-title="<?php the_title(); ?>">
			    		<div class="share twt">
					      	<a href="javascript:;">
		    ...
		    <div class="post-container col">
		    	<div class="post-wrapper">
					...
					<div class="post-footer">
						...
						<div class="post-categories">
							<span><?php _e("Categories:", 'blog'); ?> </span>
				...
				if ( $query->have_posts() ) { ?>
					...
					<div class="section-slider-posts related-posts">
			    		<h2 class="section-title"><span><?php _e("Related posts", 'blog'); ?></span></h2>
			    			...
			    			<?php while ( $query->have_posts() ) {
				    			...
				    			<div class="post">
				    				<div class="post-inner">
					    				<a href="<?php the_permalink(); ?>" class="post-image cover" style="background-image: url(<?php echo $srcc[0]; ?>);"></a>
				    					<div class="hover-top">
						    				<div class="post-info">
			    		...
			    		<div class="tac">
			    			<a href="<?php echo get_category_link($cur_cat); ?>" class="gray-button"><?php _e("See all", 'blog'); ?></a>
			    		</div>
			    	</div>
			    <?php } ?>

	    		<div class="section-comments">
	    			<h2 class="section-title"><span><?php _e("Comments", 'blog'); ?></span></h2>
