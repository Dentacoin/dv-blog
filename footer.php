			...
			<?php } ?>
			<a href="javascript::" class="single-subscribe-button active"><?php _e("Subscribe", 'blog'); ?></a>
			<div class="subscribe-wrapper">
				<a href="javascript:;" class="subscribe-button"><?php _e("Subscribe", 'blog'); ?></a>
		...
		<footer>
			<div class="container clearfix">
				...
				<div class="socials col-md-3">
					...
					<a class="social fb" href="https://www.facebook.com/dentavox.dentacoin/" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/fb.png"></a>
				</div>
			</div>
			<?php wp_footer(); ?>
		</footer>
