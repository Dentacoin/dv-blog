	    ...
	    <div class="blue-ribbon">
			<div class="container flex">
				...
				<div class="ribbon-box">
					<h2>
						<?php _e("Learn and Earn From Your Patients' Feedback!", 'blog'); ?>
					</h2>
				</div>
				<a target="_blank" href="https://reviews.dentacoin.com/?popup=popup-register" class="white-transparent-button"><?php _e("Sign up", 'blog'); ?></a>
			</div>
		</div>
